...
<div class="form-group">
	...
	<select class="form-control" name="type" id="type">
		<option value="1" @if($document->type == 1) select @endif >Empresa</option>
		<option value="2" @if($document->type == 2) select @endif >Colaborador</option>
		<option value="3" @if($document->type == 3) select @endif >Serviço</option>
	</select>
</div>
