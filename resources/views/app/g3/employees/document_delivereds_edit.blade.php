...
<div class="form-group">
                    ...
                    <option value="1" @if($delivered->company_id == 1) selected @endif>{{__('general.General')}}</option>
...
<div class="form-group">
	...
	<input type="hidden" name="company" class="form-control"  value="{{$delivered->company_id}}">
</div>
...
<div class="form-group">
		...
		<textarea type="multiline" name="observation" class="form-control" value="">{{$delivered->observation}}</textarea>
	</div>
@endcanany
